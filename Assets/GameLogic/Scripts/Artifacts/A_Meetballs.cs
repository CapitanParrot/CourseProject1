...
public class A_Meetballs : MonoBehaviour, IArtifact
{
    ...
    {
        args.PlayerManager.AddMaxHealth(4);
        args.PlayerManager.Heal(4);
        args.PlayerManager.SubSpeed(1);
    }

    public void UndoAction(Managers args)
    {
        args.PlayerManager.RemoveMaxHealth(4);
        args.PlayerManager.AddSpeed(1);
    }
}
